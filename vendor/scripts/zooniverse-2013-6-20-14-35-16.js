...
(function() {
  var $, EventEmitter, ProxyFrame, demoBucket, flaggedHost, highPort, html, messageId, _ref, _ref1,
  ...
  ProxyFrame = (function(_super) {
    ...
    ProxyFrame.prototype.host = flaggedHost || ("https://" + (demoBucket || highPort ? 'dev' : 'api') + ".zooniverse.org");
